    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        Icon = c.String(nullable: false, maxLength: 256),
                        Url = c.String(nullable: false, maxLength: 512),
                        RequiredPermissionName = c.String(maxLength: 128),
                ...
                .ForeignKey("dbo.Menues", t => t.ParentId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Menues", "TenantId", "dbo.AbpTenants");
            DropForeignKey("dbo.Menues", "ParentId", "dbo.Menues");
            DropForeignKey("dbo.Menues", "CreatorUserId", "dbo.AbpUsers");
            ...
            DropIndex("dbo.Menues", new[] { "CreatorUserId" });
            DropIndex("dbo.Menues", new[] { "ParentId" });
            DropIndex("dbo.Menues", new[] { "TenantId" });
